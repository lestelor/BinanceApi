...
import lestelabs.binanceapi.binance.api.client.BinanceApiSwapRestClient;
import lestelabs.binanceapi.binance.api.client.constant.BinanceApiConstants;
import lestelabs.binanceapi.binance.api.client.domain.SwapRemoveType;
import lestelabs.binanceapi.binance.api.client.domain.account.*;

import java.util.List;

import static lestelabs.binanceapi.binance.api.client.impl.BinanceApiServiceGenerator.createService;
import static lestelabs.binanceapi.binance.api.client.impl.BinanceApiServiceGenerator.executeSync;
