...
import lestelabs.binanceapi.binance.api.client.impl.*;
import lestelabs.binanceapi.binance.api.client.config.BinanceApiConfig;
import static lestelabs.binanceapi.binance.api.client.impl.BinanceApiServiceGenerator.getSharedClient;
